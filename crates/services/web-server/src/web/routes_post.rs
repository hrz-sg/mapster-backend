...
use lib_web::handlers::handlers_post::{
    ...
    api_get_post_detail_by_id, 
    api_list_feed_posts_handler,
...
pub fn routes(mm: ModelManager) -> Router {
    Router::new()
        ...
        .route("/api/posts/feed", get(api_list_feed_posts_handler))
        .route("/api/posts/{id}", get(api_get_post_detail_by_id))
